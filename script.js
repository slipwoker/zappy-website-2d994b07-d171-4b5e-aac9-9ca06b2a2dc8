document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearError(field) {
      ...
      const fieldWrapper = field.closest('.form-group, .field-wrapper, div') || field.parentNode;
      const errorEl = fieldWrapper.querySelector('.form-error-message');
      if (errorEl) {
        errorEl.textContent = '';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Yarden mall משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2d994b07-d171-4b5e-aac9-9ca06b2a2dc8',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2d994b07-d171-4b5e-aac9-9ca06b2a2dc8';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2d994b07-d171-4b5e-aac9-9ca06b2a2dc8';
